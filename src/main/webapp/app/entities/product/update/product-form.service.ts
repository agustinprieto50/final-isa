...
type ProductFormGroupContent = {
  ...
  lastUpdated: FormControl<IProduct['lastUpdated']>;
  customer: FormControl<IProduct['customer']>;
};
...
export class ProductFormService {
  createProductFormGroup(product: ProductFormGroupInput = { id: null }): ProductFormGroup {
    ...
    return new FormGroup<ProductFormGroupContent>({
      ...
      lastUpdated: new FormControl(productRawValue.lastUpdated),
      customer: new FormControl(productRawValue.customer),
    });
  }
